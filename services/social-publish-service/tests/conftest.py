...
async def clean_database_and_redis():
    """Clean Postgres tables and Redis publish jobs before and after each test."""
    async with test_engine.begin() as conn:
        await conn.execute(text("TRUNCATE TABLE social_publishes CASCADE;"))

    keys = (
        redis_client.keys("jobs:social-publish*")
