        ...
        <SidebarGroup className="group-data-[collapsible=icon]:hidden px-2 py-4">
            <div className="px-3 mb-4">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[9px] font-black text-accent uppercase tracking-tighter">{subscription.days_remaining} days left</span>
                </div>
                <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                    <div
                        className="h-full bg-accent transition-all duration-1000 shadow-lg shadow-accent/20"
            ...
            <SidebarMenu>
                <SidebarMenuItem>
                    <Link to="/settings/billing">
                        <SidebarMenuButton className="bg-accent/5 hover:bg-accent/10 border border-accent/10 transition-all h-14 rounded-2xl p-0 overflow-hidden group w-full">
