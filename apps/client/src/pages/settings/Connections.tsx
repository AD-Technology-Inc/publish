...
const getStatusBadge = (status: Account['status']) => {
    switch (status) {
        ...
        default:           return { variant: 'danger' as const, icon: XCircle,      text: 'Disconnected' };
    }
};
                        ...
                        <div className="grid gap-3">
                            {loading ? (
                                ...
                                accounts.map((account) => {
                                    ...
                                    return (
                                        <Card key={account.id} className="overflow-hidden border-border/50 bg-card shadow-sm hover:border-primary/20 transition-all rounded-[2rem]">
