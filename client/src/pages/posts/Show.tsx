            ...
            <div className="flex flex-col gap-8 p-6 max-w-7xl w-full mx-auto pb-20 animate-in fade-in duration-700 slide-in-from-bottom-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-6 justify-between text-left">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button className="h-12 px-8 rounded-2xl shadow-lg shadow-primary/15 font-bold gap-2 active:scale-95 transition-all outline-none">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <Card className="rounded-[2.5rem] border-border/60 bg-card shadow-lg text-left overflow-hidden border">
                            ...
                            <CardContent className="p-8 pt-4 space-y-8">
                                ...
                                <Button variant="ghost" className="w-full rounded-2xl border-0 bg-primary/5 hover:bg-primary/10 h-14 font-black text-[10px] uppercase tracking-[0.2em] text-primary transition-all shadow-none">
