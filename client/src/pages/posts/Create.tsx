...
export const CreatePost: React.FC = () => {
    ...
    const { publish, isPending, isSuccess, isFailed, error, jobStatus } =
        usePublishPost();
    ...
    const handlePublish = () => {
        ...
        publish({
            ...
            platforms: selectedPlatforms.map(
                (id) =>
                    platforms.find((p) => p.id === id)?.provider ?? "facebook",
            ),
        });
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="flex flex-col gap-6 p-6 max-w-7xl w-full mx-auto h-full overflow-hidden text-left pb-24">
                ...
                <div className="flex items-center justify-between shrink-0">
                    <div>
                        <h1 className="text-2xl font-black tracking-tight text-foreground">Compose</h1>
                        <p className="text-sm text-muted-foreground mt-0.5">Write and distribute content across channels.</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        {selectedPlatforms.length > 0 && (
                            ...
                            >
                                <DialogTrigger asChild>
                                    <Button
                                        variant="outline"
                                        className="h-9 px-4 rounded-xl border-border bg-card gap-2 text-[11px] font-black uppercase tracking-widest"
                                    >
                                        ...
                                        <div className="flex-1 overflow-y-auto p-12 flex justify-center bg-background/50">
                                                                ...
                                                                {tags.map(
                                                                    (t) => (
                                                                        <span
                                                                            ...
                                                                            className="text-[13px] text-blue-600 dark:text-blue-400 font-medium whitespace-nowrap"
                                                                        >
                                                                            #{t}
                                                                        </span>
                                                                    ),
                                            ...
                                            {activePreviewProvider ===
                                                ...
                                                <div className="w-[480px] bg-card border border-border rounded-xl h-fit shadow-lg animate-in fade-in zoom-in duration-500">
                                                    <div className="p-4 flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-black text-lg shrink-0">
                                                            P
                                                        </div>
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <p className="text-[11px] text-muted-foreground font-medium">
                                                                Just now ·{" "}
                                                                <Globe className="inline w-3 h-3 ml-0.5" />
                                                            </p>
                                                        </div>
                                                    ...
                                                    {postType !== "text" && (
                                                        <div className="aspect-video bg-muted border-y border-border/50 flex items-center justify-center">
                                                            ...
                                                            "image" ? (
                                                                ...
                                                                <Video className="w-14 h-14 text-muted-foreground/20" />
                                                            )}
                                                        </div>
                                                    )}
                                                    <div className="p-2 border-t border-border/30 flex items-center justify-around text-muted-foreground font-bold text-[11px] uppercase tracking-wider shrink-0">
                                                        <div className="flex items-center gap-2 py-2.5 px-6 hover:bg-muted rounded-xl transition-all">
                                            ...
                                            {activePreviewProvider ===
                                                ...
                                                <div className="w-[450px] bg-card border border-border rounded-[2rem] p-6 h-fit shadow-lg animate-in fade-in zoom-in duration-500">
                                                    <div className="flex gap-4">
                                                        <div className="w-12 h-12 rounded-full bg-muted shrink-0 flex items-center justify-center font-black text-xl text-primary/20">
                                                            P
                                                        </div>
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center gap-1.5">
                                                                <span className="font-black text-[15px] truncate text-foreground">
                                                                    {
                                                                        activePreviewAccount
                                                                    }
                                                                </span>
                                                            ...
                                                            <p className="text-[15px] mt-1.5 whitespace-pre-wrap text-foreground leading-relaxed font-medium">
                                                                {content ||
                                                                    "What’s happening?"}
                                                            </p>
                                                                ...
                                                                {tags.map(
                                                                    (t) => (
                                                                        <span
                                                                            ...
                                                                            className="text-[15px] text-sky-500 hover:underline cursor-pointer"
                                                                        >
                                                                            #{t}
                                                                        </span>
                                                                    ),
                                            ...
                                            {activePreviewProvider ===
                                                ...
                                                <div className="w-[460px] bg-card border border-border rounded-xl h-fit shadow-lg animate-in fade-in zoom-in duration-500 overflow-hidden">
                                                    <div className="p-4 flex items-center gap-3">
                                                        <div className="w-12 h-12 rounded bg-muted flex items-center justify-center font-black text-xl text-primary/20 shrink-0">
                                                            P
                                                        </div>
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                <span className="text-muted-foreground text-[12px] opacity-40">
                                                                    · 1st
                                                                </span>
                                                            </div>
                                                            ...
                                                            <p className="text-[11px] text-muted-foreground font-medium flex items-center gap-1.5 mt-0.5 opacity-60">
                                                                Just now ·{" "}
                                                    ...
                                                    <div className="px-5 pb-5">
                                                        <p className="text-[14px] leading-relaxed text-foreground whitespace-pre-wrap font-medium">
                                                            {content ||
                                                                "Write your professional update..."}
                                                        </p>
                                                        <div className="flex flex-wrap gap-2 mt-3">
                                                            {tags.map((t) => (
                                                                <span
                                                                    key={t}
                                                                    className="text-sm font-bold text-blue-700 dark:text-blue-400 hover:underline cursor-pointer"
                                                                >
                                                                    #{t}
                                                                </span>
                                                            ))}
                                                    ...
                                                    <div className="px-5 py-2 border-t border-border/30 flex items-center justify-between text-muted-foreground font-bold text-[11px] uppercase tracking-widest shrink-0">
                                                        <div className="flex items-center gap-2 py-3 px-3 hover:bg-muted rounded-lg transition-all">
                        ...
                        <Button
                            variant="ghost"
                            className="h-9 px-4 rounded-xl text-[11px] font-black uppercase tracking-widest text-muted-foreground hover:text-foreground"
                            onClick={() => {}}
                        >
                            Save Draft
                        </Button>
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="sm:max-w-[350px] rounded-[2rem] border border-border bg-card p-8 shadow-2xl">
                                <DialogHeader>
                                    <DialogTitle className="font-extrabold text-xl text-foreground">
                                        Schedule Post
                                    </DialogTitle>
                ...
                {isFailed && (
                    <div className="bg-rose-500/10 border border-rose-500/20 text-rose-500 p-4 rounded-xl flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm">
                                {error ||
                                    "Job encountered an error or was routed to the DLQ."}
                            </p>
                        ...
                        {dlqJobs.map((job, idx) => (
                            ...
                            >
                                ...
                                <Button
                                    size="sm"
                                    onClick={() =>
                                        handleReplayDlq(job.message_id)
                                    }
                                >
                                    Retry Job
                                </Button>
                                    ...
                                    <div className="border border-border/60 rounded-[2rem] overflow-hidden bg-muted/10 focus-within:ring-2 focus-within:ring-primary/20 transition-all flex flex-col min-h-[300px] border">
                                        <div className="bg-card/40 border-b border-border/40 px-6 py-3 flex items-center gap-4 shrink-0 overflow-x-auto no-scrollbar">
                                            ...
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                className="h-8 w-8 text-muted-foreground/50 hover:bg-background rounded-lg"
                                            >
                                    ...
                                    <div className="flex justify-between items-center px-2">
                                        <div className="flex gap-2">
                                            {selectedPlatforms.some(
                                                ...
                                                <Badge
                                                    variant="warning"
                                                    className="rounded-full px-3 py-1 font-black text-[9px] uppercase tracking-wider animate-pulse"
                                                >
                                    ...
                                    <div className="flex flex-wrap gap-2.5 items-center px-1">
                                        {tags.map((tag) => (
                                            <Badge
                                                key={tag}
                                                variant="secondary"
                                                className="rounded-full border border-border/60 bg-muted/40 px-4 py-2 gap-2.5 font-bold text-[10px] transition-all hover:bg-muted"
                                            >
                                                #{tag}{" "}
                                                <X
                                                    className="w-3.5 h-3.5 cursor-pointer hover:text-rose-500 transition-colors"
                                                    onClick={() =>
                                                        removeTag(tag)
                                                    }
                                                />
                        ...
                        <Card className="rounded-[2.5rem] border-border/60 bg-card overflow-hidden border shadow-sm flex-1">
                            <CardHeader className="p-8 pb-4 border-b border-border/20 bg-muted/10 flex flex-row items-center justify-between">
                                <div className="space-y-0.5 text-left">
                                    ...
                                    <CardDescription className="text-[10px] uppercase font-black text-muted-foreground tracking-widest opacity-40">
                                        Choose accounts
                                    </CardDescription>
                                </div>
                                ...
                                {platforms.length === 0 ? (
                                    <div className="p-6 flex flex-col items-center text-center gap-4">
                                        ...
                                        >
                                            <Button
                                                variant="outline"
                                                className="w-full rounded-2xl h-11 font-bold text-xs gap-2"
                                            >
                                    ...
                                    platforms.map((platform) => (
                                        ...
                                        >
                                            ...
                                            {selectedPlatforms.includes(
                                                ...
                                                <div
                                                    className={cn(
                                                        "rounded-full p-1.5 shadow-lg ring-4 ring-card shrink-0 animate-in zoom-in duration-300",
                                                        platform.color
                                                            .replace(
                                                                "text-",
                                                                "bg-",
                                ...
                                {platforms.length > 0 && (
                                    <div className="p-4 pt-6">
                                        <Link to="/settings/connections">
                                            <Button
                                                variant="outline"
                                                className="w-full border-dashed border-border/60 bg-muted/5 hover:bg-muted/10 rounded-2xl h-14 text-[10px] font-black uppercase tracking-[0.15em] gap-3 text-muted-foreground/60 transition-all hover:text-foreground"
                                            >
                    ...
                    <Card className="w-full max-w-sm rounded-[3rem] border border-white/5 bg-card/80 text-card-foreground animate-in zoom-in slide-in-from-bottom-10 duration-500 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.5)] border">
                        <CardContent className="p-12 text-center space-y-8">
                            ...
                            <div className="space-y-3 pt-4">
                                ...
                                <Button
                                    variant="ghost"
                                    className="w-full h-12 rounded-2xl font-bold text-xs text-muted-foreground/40"
