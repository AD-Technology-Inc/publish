            ...
            <SettingsLayout size="md">
                <div className="space-y-10 text-left pb-20">
                    ...
                    <section className="space-y-4">
                        ...
                        <Card className="rounded-[2.5rem] border-border/60 bg-linear-to-br from-primary/5 to-transparent shadow-none overflow-hidden relative group">
                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4">
                                            <div className="p-4 rounded-2xl bg-primary text-primary-foreground shadow-xl shadow-primary/15">
                                    ...
                                    <div className="flex flex-col gap-3 min-w-[200px]">
                                        ...
                                        <Button className="w-full rounded-2xl font-bold h-12 shadow-lg shadow-primary/15">Manage Billing</Button>
